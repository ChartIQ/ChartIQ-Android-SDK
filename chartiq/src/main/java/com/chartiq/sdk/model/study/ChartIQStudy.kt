...
interface ChartIQStudy {
     ...
     * @param callback A callback to subscribe on to get a list of studies
     */
     ...
     * @param callback A callback to subscribe on to get a list of parameters [StudyParameter]
     */
