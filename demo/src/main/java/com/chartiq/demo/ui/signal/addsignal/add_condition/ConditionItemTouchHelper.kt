...
import com.chartiq.demo.ui.signal.addsignal.ConditionsAdapter

class ConditionItemTouchCallBack(
    ...
    override fun getSwipeDirs(
        ...
        return when (viewHolder) {
            is ConditionsAdapter.ConditionsViewHolder -> super.getSwipeDirs(
                recyclerView,
                viewHolder
            )
            else -> 0
    ...
    override fun onChildDraw(
        ...
        when {
            ...
            dX < 0 -> { // Swiping to the left
                ...
                textX =
                    if (itemView.right + dX.toInt() < (itemView.right - bounds.width() * 2).toFloat()) {
