...
class DefaultApplicationPrefs(context: Context) : ApplicationPrefs {
        ...
        prefs.edit {
            when (chartViewState) {
                is ChartViewState.FullView -> {
                    putBoolean(KEY_CHART_VIEW_MENU_EXPANDED, false)
                ...
                is ChartViewState.Simple.Portrait -> {
                    putBoolean(
                        KEY_CHART_VIEW_MENU_EXPANDED,
                        chartViewState.menuExpanded
                    )
                    putString(
                        KEY_CHART_VIEW_STATE,
    ...
    override fun getChartViewState(): ChartViewState {
        ...
        val menuExpanded = prefs.getBoolean(KEY_CHART_VIEW_MENU_EXPANDED, false)
        ...
        return when (prefs.getString(
            ...
            else -> ChartViewState.Simple.Portrait(menuExpanded)
        }
    }
    ...
    companion object {
        ...
        private const val KEY_CHART_VIEW_MENU_EXPANDED = "chart.iq.demo.chart.menuExpanded"
    }
